...
public class OnePlatformSecurityDecisionProvider extends SecurityDecisionProvider {
	...
	public List<String> anonymousUrlPatterns() {
		return Arrays.asList(StringUtils.splitByWholeSeparator(ResourceUtils.getProperty("anonymous.uris"), ";"));
	}
	...
	@Override
	public Map<String, List<String>> getUserPermissionCodes(String s) {
		return null;
	}
